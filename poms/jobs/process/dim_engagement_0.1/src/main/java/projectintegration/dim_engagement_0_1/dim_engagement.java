...
package projectintegration.dim_engagement_0_1;
...
public class dim_engagement implements TalendJob {
	...
	public static class outStruct implements routines.system.IPersistableRow<outStruct> {
		final static byte[] commonByteArrayLock_PROJECTINTEGRATION_dim_engagement = new byte[0];
		static byte[] commonByteArray_PROJECTINTEGRATION_dim_engagement = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_PROJECTINTEGRATION_dim_engagement.length) {
					if (length < 1024 && commonByteArray_PROJECTINTEGRATION_dim_engagement.length == 0) {
						commonByteArray_PROJECTINTEGRATION_dim_engagement = new byte[1024];
					} else {
						commonByteArray_PROJECTINTEGRATION_dim_engagement = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_PROJECTINTEGRATION_dim_engagement, 0, length);
				strReturn = new String(commonByteArray_PROJECTINTEGRATION_dim_engagement, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PROJECTINTEGRATION_dim_engagement) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:TAGD65U2uGZfaphvTvugZVyed96Kw9cJ0C1guA==");
				...
				if (dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
					tableName_tDBOutput_1 = "dim_engagment";
				} else {
					tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "].[" + "dim_engagment";
				}
...
// ###############################
				...
				final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:u5eNo6THwwEN4KGWhyGzZ2AQ0Tog88w3tsPtsw==");
				...
				String dbquery_tDBInput_1 = "SELECT dbo.survey.employee_id,\n		dbo.survey.department,\n		dbo.survey.engagement,\n		dbo.survey.salary,\n		dbo.survey.vaca"
						+ "tion_days_taken\nFROM	dbo.survey";
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						...
						if (colQtyInRs_tDBInput_1 < 3) {
							...
							row1.engagement = rs_tDBInput_1.getInt(3);
							if (rs_tDBInput_1.wasNull()) {
								row1.engagement = null;
							}
						}
						if (colQtyInRs_tDBInput_1 < 4) {
							...
							row1.salary = rs_tDBInput_1.getFloat(4);
							if (rs_tDBInput_1.wasNull()) {
								row1.salary = null;
							}
						}
						if (colQtyInRs_tDBInput_1 < 5) {
							...
							row1.vacation_days_taken = rs_tDBInput_1.getInt(5);
							if (rs_tDBInput_1.wasNull()) {
								row1.vacation_days_taken = null;
							}
						}
...
// # Output table : 'out'
							out_tmp.employee_id = row1.employee_id;
							out_tmp.department = row1.department;
							out_tmp.engagement = row1.engagement;
							out_tmp.salary = row1.salary;
							out_tmp.vacation_days_taken = row1.vacation_days_taken;
							out = out_tmp;
// ###############################
...
// Start of branch "out"
						if (out != null) {
							...
							if (out.employee_id == null) {
								pstmt_tDBOutput_1.setNull(1, java.sql.Types.INTEGER);
							} else {
								pstmt_tDBOutput_1.setInt(1, out.employee_id);
							}

							if (out.department == null) {
								pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_1.setString(2, out.department);
							}

							if (out.engagement == null) {
								pstmt_tDBOutput_1.setNull(3, java.sql.Types.INTEGER);
							} else {
								pstmt_tDBOutput_1.setInt(3, out.engagement);
							}

							if (out.salary == null) {
								pstmt_tDBOutput_1.setNull(4, java.sql.Types.FLOAT);
							} else {
								pstmt_tDBOutput_1.setFloat(4, out.salary);
							}

							if (out.vacation_days_taken == null) {
								pstmt_tDBOutput_1.setNull(5, java.sql.Types.INTEGER);
							} else {
								pstmt_tDBOutput_1.setInt(5, out.vacation_days_taken);
							}
...
// ###############################      
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = dim_engagement.class.getClassLoader().getResourceAsStream(
					"projectintegration/dim_engagement_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 55380 characters generated by Talend Open Studio for Big Data on the June 4,
 * 2020 2:03:04 PM WEST
 ************************************************************************************************/